  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Arshad excels in
      ...
      <br />
      <span>
        Arshad is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional journey, Arshad is a huge fan of football and holds immense admiration for <strong>Lionel Messi.</strong> His passion for the sport and the values he draws from his idol — dedication, humility, and perseverance — have greatly influenced his journey, constantly motivating him to strive for excellence.
      </p>
    </div>
  );
}
